            ...
            <div class="bg-white rounded-sm shadow-md mb-4">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-1 sm:grid-cols-1 p-4 pt-0 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="sales_quotation_version" placeholder="Version"
                        name="sales_quotation_type"
                            class="border rounded-sm outline-none p-2 w-full focus:ring focus:ring-blue-400 mt-2">
                    </div>
                </div>
                <div class="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 p-4 pt-0 gap-4">
                    <div>
                        ...
                        <input type="date" id="sales_quotation_valid_till"
                        name="sales_quotation_valid_till"
                            class="border rounded-sm outline-none p-2 w-full focus:ring focus:ring-blue-400 mt-2" style="color: #999999;">
                    </div>
                    <div>
                        <label for="sales_quotation_currency" class="text-gray-700 font-semibold">Currency</label>
                        <select
                            name="sales_quotation_currency"
                            id="sales_quotation_currency"
                            class="border rounded-sm outline-none p-2 w-full focus:ring focus:ring-blue-400 !important"
                        >
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-4">
                            <div class="flex items-center mr-3">
                                <input type="radio" id="domestic" name="sales_quotation_type"
                                name="qsales_quotation_type"
                                class="border rounded-sm outline-none p-3 mr-2 w-5 h-5" value="Domestic">
                                <label for="domestic" class="text-gray-400 font-normal">Domestic</label>
                            </div>
                            <div class="flex items-center">
                                <input type="radio" id="export" name="sales_quotation_type"
                                name="qsales_quotation_type"
                                class="border rounded-sm outline-none p-2 mr-2 w-5 h-5" value="Export">
                    ...
                    <div>
                        ...
                        <input type="text" id="sales_quotation_sr_by" placeholder="Source / Referred By"
                        name="sales_quotation_sr_by"
                            class="border rounded-sm outline-none p-2 w-full focus:ring focus:ring-blue-400 mt-2">
                    </div>
                </div>
                <div class="grid p-4 pt-0 gap-4">
                    <div class="col-span-full">
                        ...
                        <input type="text" id="sales_quotation_description" placeholder="Description"
                        name="sales_quotation_description"
                            class="border rounded-sm outline-none p-2 w-full focus:ring focus:ring-blue-400 mt-2">
                    </div>
                </div>
            </div>
